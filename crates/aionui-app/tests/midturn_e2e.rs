...
///
/// `send_message` returns 202 as soon as the turn is claimed, but the agent is
/// built lazily inside the detached turn task. Mid-turn delivery is available
/// only after that registration completes.
