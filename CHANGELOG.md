...
## [0.3.0](https://github.com/suoak/AionCore/compare/v0.2.13...v0.3.0) (2026-09-17)


### ⚠ BREAKING CHANGES

* **skills:** deliver skills through an AionUi-owned view instead of the workspace ([#938](https://github.com/suoak/AionCore/issues/938))
* **skills:** deliver skills through an AionUi-owned view instead of the workspace ([#938](https://github.com/suoak/AionCore/issues/938))

### Features

* **acp:** client-hosted terminals — declare clientCapabilities.terminal and serve terminal/* ([#779](https://github.com/suoak/AionCore/issues/779)) ([c5fef5f](https://github.com/suoak/AionCore/commit/c5fef5f7ede02690c99bb97a7019a1b075cf939b))
...
* **agent-center:** expose preview_mode on try-run plan ([022908a](https://github.com/suoak/AionCore/commit/022908a43985745ef7e7cc5c6091b6024b5d3c5f))
* **agent-center:** expose preview_mode on try-run plan ([53e8d93](https://github.com/suoak/AionCore/commit/53e8d93e56f629a03399aad7833252e0effce700))
...
* **agent-center:** MVP Core model/API/routes ([#109](https://github.com/suoak/AionCore/issues/109)) ([27de2a8](https://github.com/suoak/AionCore/commit/27de2a8cb3316992ac6ca3f5805948ba6d2d0370))
...
* **agent:** drive lifecycle from declared behavior policy ([7909ce9](https://github.com/suoak/AionCore/commit/7909ce94157591284866033c40ff48fa8494023a))
* **agent:** multimodal prompt — native image/audio content blocks gated by promptCapabilities ([#774](https://github.com/suoak/AionCore/issues/774)) ([5a78a0b](https://github.com/suoak/AionCore/commit/5a78a0b2722edcce9f979d3f06c4461577f9e574))
* **agents:** add DeepSeek Harness preview agent ([#24](https://github.com/suoak/AionCore/issues/24)) ([353880e](https://github.com/suoak/AionCore/commit/353880e0f6bc4f33fd50e49c2c89a357600a2707))
* **assistant:** add Lark Work Assistant avatar ([8f3c457](https://github.com/suoak/AionCore/commit/8f3c457d0d58f9a720b9feef23d8172873120d25))
* **auth:** account/secret CLI and decoupled encryption root ([#917](https://github.com/suoak/AionCore/issues/917)) ([61c8008](https://github.com/suoak/AionCore/commit/61c80088cc3b306eef2b274a5d9716079ab2f7f8))
* **auth:** account/secret CLI and decoupled encryption root ([#917](https://github.com/suoak/AionCore/issues/917)) ([0251be7](https://github.com/suoak/AionCore/commit/0251be76481c56283edbe067bfac548d7d45d534))
* **auth:** dual-token refresh with singleflight ([#926](https://github.com/suoak/AionCore/issues/926)) ([b073d03](https://github.com/suoak/AionCore/commit/b073d03d526cd9c39e9841a7b405af23b773b539))
* **auth:** dual-token refresh with singleflight ([#926](https://github.com/suoak/AionCore/issues/926)) ([3f5c9f9](https://github.com/suoak/AionCore/commit/3f5c9f900433dd846798a82353df03dfed8db697))
* **channel:** add Discord Gateway plugin ([#813](https://github.com/suoak/AionCore/issues/813)) ([f711607](https://github.com/suoak/AionCore/commit/f71160760266f8f5507ff355e484b9f11bc336b0))
* **channel:** add Slack Socket Mode plugin ([#806](https://github.com/suoak/AionCore/issues/806)) ([ff887f1](https://github.com/suoak/AionCore/commit/ff887f1fd6ff787d59448a8353e4ac1d98f73081))
* **claude:** label tool steps by what they do ([#870](https://github.com/suoak/AionCore/issues/870)) ([69c3eb1](https://github.com/suoak/AionCore/commit/69c3eb19dc2509f25cf94970f80618584e37bf13))
* **claude:** label tool steps by what they do ([#870](https://github.com/suoak/AionCore/issues/870)) ([6757d0f](https://github.com/suoak/AionCore/commit/6757d0fdd2aec726e2be65b210176712972f56cb))
* **codex:** auto-name sessions and label command steps ([#868](https://github.com/suoak/AionCore/issues/868)) ([25ad2bb](https://github.com/suoak/AionCore/commit/25ad2bb5a689bcecd77b08838ee5df3740f84be4))
* **codex:** auto-name sessions and label command steps ([#868](https://github.com/suoak/AionCore/issues/868)) ([7aedbbd](https://github.com/suoak/AionCore/commit/7aedbbdcaf2835f8675db8cea87381aed4a91f10))
...
* **conversation:** add canonical event journal ([#26](https://github.com/suoak/AionCore/issues/26)) ([66c144a](https://github.com/suoak/AionCore/commit/66c144ac982cbc6523e0607230f1820e88908d8f))
* **conversation:** add semantic trajectories and hardened media ([#70](https://github.com/suoak/AionCore/issues/70)) ([ec81079](https://github.com/suoak/AionCore/commit/ec8107950a7bc022b66d965a708005e0049ceddf))
* **conversation:** agent-driven session auto-naming (ACP session_info_update + claude generate_session_title) ([#768](https://github.com/suoak/AionCore/issues/768)) ([c551c66](https://github.com/suoak/AionCore/commit/c551c6614270ba6bf045627a1598e71bbf77d63d))
* **conversation:** classify tool pre-execute on the host pipeline ([1adc075](https://github.com/suoak/AionCore/commit/1adc075416b7cdd6ec18e31090f8055edc1000b2))
* **conversation:** compact older tool results in the transcript ([f4ca0cd](https://github.com/suoak/AionCore/commit/f4ca0cd853a4d1d213598ab632ba2364c05ff385))
* **conversation:** converge cancellation after tools stop ([dd610ad](https://github.com/suoak/AionCore/commit/dd610ad8a4b521ce1e465c1056e32ca4db95c431))
* **conversation:** converge cancellation after tools stop ([50ebf49](https://github.com/suoak/AionCore/commit/50ebf491d7c46c64ec06fe1ea735e9b478432b1a))
* **conversation:** converge durable input and cancellation state ([#59](https://github.com/suoak/AionCore/issues/59)) ([8e3cba9](https://github.com/suoak/AionCore/commit/8e3cba9abd48719088e4ffa59ef70dfad17d0ad9))
* **conversation:** derive a host transcript from the journal ([35622b7](https://github.com/suoak/AionCore/commit/35622b7e81875e924b16218c9baaab4b96d98b22))
* **conversation:** fork a conversation into a new one at a chosen message ([#772](https://github.com/suoak/AionCore/issues/772)) ([bb7c14e](https://github.com/suoak/AionCore/commit/bb7c14ef26f5af1157946841d12c5027c486cc21))
* **conversation:** govern large tool output ([#25](https://github.com/suoak/AionCore/issues/25)) ([0db0559](https://github.com/suoak/AionCore/commit/0db0559adf692d9092a9f67475bb861411035fdc))
* **conversation:** host tool post-execute pipeline ([eeb683f](https://github.com/suoak/AionCore/commit/eeb683f1493ef3fc90468028dfeabe51fa99133c))
* **conversation:** journal invariants and fail-closed approval ([#37](https://github.com/suoak/AionCore/issues/37)) ([43b7668](https://github.com/suoak/AionCore/commit/43b76688f8993b12d996c1d516b708632cea9de6))
* **conversation:** journal user prompts with reconstructible content ([be4352d](https://github.com/suoak/AionCore/commit/be4352da2e1974c46df93f8f8431c9bf63cc0596))
* **conversation:** mid-turn interjection — deliver messages while a turn is in flight ([#836](https://github.com/suoak/AionCore/issues/836)) ([4664fa7](https://github.com/suoak/AionCore/commit/4664fa7ec5fe3cf1fb1b33fba966627b3b3ef364))
* **conversation:** mid-turn interjection — deliver messages while a turn is in flight ([#836](https://github.com/suoak/AionCore/issues/836)) ([484327d](https://github.com/suoak/AionCore/commit/484327dbbcd44ca8752c133dfe2fe04c901bafbb))
* **conversation:** persist capabilities and dispatch steer ([ef4ccec](https://github.com/suoak/AionCore/commit/ef4cceceed1fa52dbbdc76a797175bb6fe8104df))
* **conversation:** persist capabilities and dispatch steer ([8343e4a](https://github.com/suoak/AionCore/commit/8343e4ace5dfc1af6ecef2e4d8fe5f92e45cddb3))
* **conversation:** persist plan snapshots and expose them for rehydration ([#916](https://github.com/suoak/AionCore/issues/916)) ([7ac46e1](https://github.com/suoak/AionCore/commit/7ac46e1ecb28f85b1a67ca9321f695a8d581879f))
* **conversation:** persist plan snapshots and expose them for rehydration ([#916](https://github.com/suoak/AionCore/issues/916)) ([b2f12e9](https://github.com/suoak/AionCore/commit/b2f12e952ec8e71ed37f6240108998c9d7b016a1))
* **conversation:** recover durable inputs and support injection ([#57](https://github.com/suoak/AionCore/issues/57)) ([82a5a88](https://github.com/suoak/AionCore/commit/82a5a8802c1dbf40e071645dc9a88342b5ec03f4))
* **conversation:** retire DSH preview and persist host policies ([#49](https://github.com/suoak/AionCore/issues/49)) ([d183826](https://github.com/suoak/AionCore/commit/d1838261c3cd0f8fc258ee69a6ead5915586a73d))
* **conversation:** route @@ mentions to the session-message skill ([#949](https://github.com/suoak/AionCore/issues/949)) ([1c37366](https://github.com/suoak/AionCore/commit/1c37366f5d94994282c920323f159946b38a9b30))
* **conversation:** route @@ to session-message skill + capabilities fallback ([19aa259](https://github.com/suoak/AionCore/commit/19aa2593baf4981c8fe2ca001c321d2254898759))
* **conversation:** route @@ to session-message skill + capabilities fallback ([15dfeb0](https://github.com/suoak/AionCore/commit/15dfeb0d2a4c2c42da6d1c22245708cf9fb0e848))
* **conversation:** support forking aionrs conversations ([6e04e74](https://github.com/suoak/AionCore/commit/6e04e741c42425072a8296fdacd95e5d1261d4d7))
* **conversation:** support forking aionrs conversations ([4b09341](https://github.com/suoak/AionCore/commit/4b0934145b46f208d75f63e14dfb190dd4fb06b8))
* **core:** add journal-backed conversation inputs ([#54](https://github.com/suoak/AionCore/issues/54)) ([3d36337](https://github.com/suoak/AionCore/commit/3d36337b55e9ada3e0ef59f03d9a9e9ce3676955))
* **db:** dedicated startup stage for database created by a newer app (downgrade) ([#834](https://github.com/suoak/AionCore/issues/834)) ([db7ce9a](https://github.com/suoak/AionCore/commit/db7ce9ae2fe25081bd2485aae53bae665eb7ca10))
* **fs:** add ChatFileRef content endpoints ([#757](https://github.com/suoak/AionCore/issues/757)) ([e8b6f4c](https://github.com/suoak/AionCore/commit/e8b6f4c825e04bc2c454ac75005d6f7f7642926d))
* **fs:** add copy-absolute-path endpoint that writes the clipboard server-side ([#803](https://github.com/suoak/AionCore/issues/803)) ([a621ed8](https://github.com/suoak/AionCore/commit/a621ed888c662bce2deaf16b30a9ccf8ab588804))
* **fs:** pdf stream endpoint + office ChatFileRef resolve + retire fs/resolve & WS fs/read ([#762](https://github.com/suoak/AionCore/issues/762)) ([e4e991a](https://github.com/suoak/AionCore/commit/e4e991afed637346e57578a3da48b6a3c62ce960))
* **journal:** checkpoint input projections ([f0bf7e2](https://github.com/suoak/AionCore/commit/f0bf7e2926f153993d88a65217e6e7f44e529bc7))
* **journal:** checkpoint input projections ([aa9097e](https://github.com/suoak/AionCore/commit/aa9097e844d0b356590eafa4dc5ee553aa803ebc))
* **journal:** enable cursor replay for projector ([0b03d3a](https://github.com/suoak/AionCore/commit/0b03d3ab9af30b474e44c4a33c1033502fedf222))
* **journal:** recover stale tools from durable facts ([444bb78](https://github.com/suoak/AionCore/commit/444bb78887cf8cff4c5574576ebaa608e3900555))
* **journal:** recover stale tools from durable facts ([87353da](https://github.com/suoak/AionCore/commit/87353da46eebdb9837165296e57695015998bfbe))
* **monitor:** add fs/createFile command ([#891](https://github.com/suoak/AionCore/issues/891)) ([731a3d5](https://github.com/suoak/AionCore/commit/731a3d58e23ea5611340f7b64c83d9de8a3e352f))
* **monitor:** add fs/createFile command ([#891](https://github.com/suoak/AionCore/issues/891)) ([19c7837](https://github.com/suoak/AionCore/commit/19c7837ba5c5ce6dffa022478d5322275805097c))
* **monitor:** back explorer drag-transfer with fs/copy and fs/move ([#877](https://github.com/suoak/AionCore/issues/877)) ([94d8dc3](https://github.com/suoak/AionCore/commit/94d8dc36a5c9f8a88e857d45ed454751b19261ea))
* **monitor:** back explorer drag-transfer with fs/copy and fs/move ([#877](https://github.com/suoak/AionCore/issues/877)) ([85670aa](https://github.com/suoak/AionCore/commit/85670aa2ebd7bdda180e89bec07f6158d101f7ef))
* **office:** support bundled officecli runtime ([#74](https://github.com/suoak/AionCore/issues/74)) ([685af11](https://github.com/suoak/AionCore/commit/685af112b3bfb212dc721690e5097d9e9afd0096))
* **presentation:** add native deck orchestration API ([#88](https://github.com/suoak/AionCore/issues/88)) ([1755e31](https://github.com/suoak/AionCore/commit/1755e31c4a0cae3fffdda40d44588a8e6d2e59fc))
* **preview:** backend half of preview v2 — office refresh, overflow marker, content-change signal ([#780](https://github.com/suoak/AionCore/issues/780)) ([eb4bd7f](https://github.com/suoak/AionCore/commit/eb4bd7f78219fcb0bc50c52affb456a19b04bed1))
* **project:** add fs/remount to rebuild stale mounts ([#910](https://github.com/suoak/AionCore/issues/910)) ([9787266](https://github.com/suoak/AionCore/commit/978726639e76a50595d6a5ea23eed4dc8f474d33))
* **project:** add fs/remount to rebuild stale mounts ([#910](https://github.com/suoak/AionCore/issues/910)) ([345f70b](https://github.com/suoak/AionCore/commit/345f70b3d4cee250ef12a7efa425e78f5f11960e))
* **runtime:** add versioned DeepSeek Harness installer ([#23](https://github.com/suoak/AionCore/issues/23)) ([49134e7](https://github.com/suoak/AionCore/commit/49134e7f8d234b89b8c103d938d538aaac0d7a99))
* **scm:** enumerate a repository's linked worktrees during discovery ([#959](https://github.com/suoak/AionCore/issues/959)) ([8da6c31](https://github.com/suoak/AionCore/commit/8da6c31ad93f3d7f38faaaec4f1bba6f8b6129a1))
* **scm:** enumerate linked worktrees during discovery ([c9f0edf](https://github.com/suoak/AionCore/commit/c9f0edfba1547112247850e1ec55b1e2ede5504f))
* **scm:** enumerate linked worktrees during discovery ([040d8e8](https://github.com/suoak/AionCore/commit/040d8e8e6a383dff12975aaa7b67fcb639249262))
* **scm:** live repository-set changes + pe_name ([#790](https://github.com/suoak/AionCore/issues/790)) ([81ef258](https://github.com/suoak/AionCore/commit/81ef258913e6ac5076a86d4adcc7edcc0f8f21ef))
* **scm:** one-level repository discovery for workspace roots ([#800](https://github.com/suoak/AionCore/issues/800)) ([3d0e276](https://github.com/suoak/AionCore/commit/3d0e276078fe95180c9267bdbde548096459becb))
* **session-message:** add session capabilities fallback to @@ blocks ([#952](https://github.com/suoak/AionCore/issues/952)) ([1f511e5](https://github.com/suoak/AionCore/commit/1f511e5e863e3a76a65400e6f189c7e23e8dde2a))
* **session-message:** deliver messages across a user's conversations ([#914](https://github.com/suoak/AionCore/issues/914)) ([1d811e3](https://github.com/suoak/AionCore/commit/1d811e34035134fb51f2aab21463909fdb3f44e4))
* **session-message:** deliver messages across a user's conversations ([#914](https://github.com/suoak/AionCore/issues/914)) ([f2b490f](https://github.com/suoak/AionCore/commit/f2b490f821fbc781b248d497e2955a9869213b02))
* **session:** AskUserQuestion as a first-class capability (own event, command, counter and endpoint) ([#778](https://github.com/suoak/AionCore/issues/778)) ([f9cf506](https://github.com/suoak/AionCore/commit/f9cf506d5755d0ae8d6a4e9e28fea5cdd3880bce))
* **session:** distinguish Task subagents from background tasks ([#890](https://github.com/suoak/AionCore/issues/890)) ([fd7e6fa](https://github.com/suoak/AionCore/commit/fd7e6faff227154a9258ff5c6f37a21d35cbac2e))
* **session:** distinguish Task subagents from background tasks ([#890](https://github.com/suoak/AionCore/issues/890)) ([a978cf7](https://github.com/suoak/AionCore/commit/a978cf71a932842d2c83b7598de002c85a7dd95c))
* **session:** make background work visible — live progress cards and out-of-turn delivery ([#758](https://github.com/suoak/AionCore/issues/758)) ([f0422ca](https://github.com/suoak/AionCore/commit/f0422ca28b08b3e16e8e8e2dd1778e816694095e))
* **session:** report a deferred mode switch as pending instead of observed ([#846](https://github.com/suoak/AionCore/issues/846)) ([9700f88](https://github.com/suoak/AionCore/commit/9700f88306aa9c2d51d257e865866253db002bd6))
* **sidebar:** add user_order ordering base and sidebar grouping API ([#820](https://github.com/suoak/AionCore/issues/820)) ([d2f9f8c](https://github.com/suoak/AionCore/commit/d2f9f8ce9e8793a350835fdf36f2973f3cc95b3d))
* **sidebar:** archive foundation and aggregated read model ([#911](https://github.com/suoak/AionCore/issues/911)) ([25dbbe5](https://github.com/suoak/AionCore/commit/25dbbe5e4eb9cbd07a69c780650f3594b54d920f))
* **sidebar:** archive foundation and aggregated read model ([#911](https://github.com/suoak/AionCore/issues/911)) ([8d6f6cc](https://github.com/suoak/AionCore/commit/8d6f6ccdbbadd69fb45a60b5cc135f256bd7359b))
* **sidebar:** tear down agent processes on archive ([#925](https://github.com/suoak/AionCore/issues/925)) ([6b37a9a](https://github.com/suoak/AionCore/commit/6b37a9abb0a827ad4692ec08093a315b885f53c5))
* **sidebar:** tear down agent processes on archive ([#925](https://github.com/suoak/AionCore/issues/925)) ([7ac84f9](https://github.com/suoak/AionCore/commit/7ac84f93c5f81e1b1cc41f8119c089df72d63afc))
* **skill-evolution:** MVP schema + APIs for 技能进化 ([807122a](https://github.com/suoak/AionCore/commit/807122ac133896468297b3779dd2540da68f1564))
* **skill-evolution:** MVP schema + APIs（技能进化） ([01de64c](https://github.com/suoak/AionCore/commit/01de64cdbe7b80d3aa55604ee6cb7c45821c5014))
* **skill-evolution:** Phase 2 LLM evolve + Skills Hub apply/pin ([#113](https://github.com/suoak/AionCore/issues/113)) ([3088395](https://github.com/suoak/AionCore/commit/308839586b6626afda84a0e78ba2d5a0f69131a8))
* **skill-evolution:** Phase 3 heuristic gate + team experience ACL ([#116](https://github.com/suoak/AionCore/issues/116)) ([c0ff905](https://github.com/suoak/AionCore/commit/c0ff905db9f52e9e0a93f252c13f584c061b978f))
* **skill-evolution:** prior notes on re-evolve + clearer apply errors ([#114](https://github.com/suoak/AionCore/issues/114)) ([53efe0a](https://github.com/suoak/AionCore/commit/53efe0a56623a0f23b0f0d22b8e659dd2bbfa4c6))
* **skills:** deliver skills through an AionUi-owned view instead of the workspace ([#938](https://github.com/suoak/AionCore/issues/938)) ([11c2c75](https://github.com/suoak/AionCore/commit/11c2c75bf04cd9991b15ef4fd0ef7f0dde8ca417))
* **skills:** deliver skills through an AionUi-owned view instead of the workspace ([#938](https://github.com/suoak/AionCore/issues/938)) ([7032b3b](https://github.com/suoak/AionCore/commit/7032b3b410440c0081fb3cfe4a09f2ccfb2dd574))
* **skills:** migrate workspace path to workmate brand ([2414516](https://github.com/suoak/AionCore/commit/2414516b0f1953fa15423ed064840da476457289))
* **skills:** migrate workspace path to WorkMate brand ([#17](https://github.com/suoak/AionCore/issues/17)) ([175b9ea](https://github.com/suoak/AionCore/commit/175b9eacef9d743f984200a66f38a549bb9260f5))
...
* **team:** add fresh context reset contract ([3bda96e](https://github.com/suoak/AionCore/commit/3bda96e465f30ec758ede9d93e21fe03e7e0b5dc))
* **team:** add interrupt-and-send command ([a1355a9](https://github.com/suoak/AionCore/commit/a1355a91e380f9b07e5af7a1b87d1f7fe4fe3d94))
* **team:** add member context reset ([a00d9cd](https://github.com/suoak/AionCore/commit/a00d9cd241807b407037db7dccd2ed65e53c8d62))
* **team:** add member runtime restart endpoint ([5068577](https://github.com/suoak/AionCore/commit/50685771f0a9ea7468346d7b5d79a8e03de104a2))
* **team:** add read-only mailbox/task activity API and real-time events ([#740](https://github.com/suoak/AionCore/issues/740)) ([f86c053](https://github.com/suoak/AionCore/commit/f86c053eded3e04f5139dadeb3bdb9bae94c9c3b))
* **team:** add unread message peek tool ([2fe9577](https://github.com/suoak/AionCore/commit/2fe9577c40ebe7753a694c1c0d47bc0281846d9b))
* **team:** persist member model selection ([dfc79c7](https://github.com/suoak/AionCore/commit/dfc79c7b98ad4cdb1eafd134bbf87d0ad9440ee4))
* **team:** refresh enabled MCP servers for sessions ([f577c30](https://github.com/suoak/AionCore/commit/f577c305ed32058dd2113acdfa6f9e03a1f2bf9f))
* **team:** ship reliability slices for 0.2.3 ([c77a063](https://github.com/suoak/AionCore/commit/c77a063cea02f17b6e5f91571bcf27f6abd8e274))
* **team:** team mode reliability improvements, model switch persistence and runtime restart ([#787](https://github.com/suoak/AionCore/issues/787)) ([e9b6f13](https://github.com/suoak/AionCore/commit/e9b6f13983cc787bbc329b0e2d98cd89e157b76a))
* **usage:** persist completed-turn spend across all sources ([#44](https://github.com/suoak/AionCore/issues/44)) ([1f157a5](https://github.com/suoak/AionCore/commit/1f157a5b029b6d3f494dcc9ea8f0e7e6c877de9b))


### Bug Fixes

* **acp:** give a first-run npx agent room to install before initialize times out ([#854](https://github.com/suoak/AionCore/issues/854)) ([f6131a4](https://github.com/suoak/AionCore/commit/f6131a4ace14c90946de009ec8315f1c37f44e0f))
* **acp:** record Grok turn_completed usage into the ledger ([#46](https://github.com/suoak/AionCore/issues/46)) ([ba20784](https://github.com/suoak/AionCore/commit/ba2078440379fccafb590c0a75110a2a24a1e916))
* **acp:** stop collapsing agent failures into an opaque -32603 ([#869](https://github.com/suoak/AionCore/issues/869)) ([a852971](https://github.com/suoak/AionCore/commit/a85297126b1ddff3a0f21af22200569c90f20357))
* **acp:** stop collapsing agent failures into an opaque -32603 ([#869](https://github.com/suoak/AionCore/issues/869)) ([27fc006](https://github.com/suoak/AionCore/commit/27fc006a9811bdb55153741cfb549ad1b42c3751))
* **acp:** trim Grok modelUsage keys as strings ([#47](https://github.com/suoak/AionCore/issues/47)) ([0a9ab2b](https://github.com/suoak/AionCore/commit/0a9ab2bd06b24a911a53756b9ff0de2d01485e35))
* **adoption:** move legacy root assistant-rules to the adopter ([#788](https://github.com/suoak/AionCore/issues/788)) ([0b678e8](https://github.com/suoak/AionCore/commit/0b678e8a6812bd9c734a8c825fb2c6fca6079661))
...
* **agent:** keep the thought-level picker on a resumed conversation ([#763](https://github.com/suoak/AionCore/issues/763)) ([dcf015e](https://github.com/suoak/AionCore/commit/dcf015eda00a1a5fe3952fc7eaa1c3236a5b8e9b))
* **agent:** pair native media blocks with a link to the same file ([#876](https://github.com/suoak/AionCore/issues/876)) ([fb085a8](https://github.com/suoak/AionCore/commit/fb085a8cdb88790e523c3b9917fa3acf092d4746))
* **agent:** pair native media blocks with a link to the same file ([#876](https://github.com/suoak/AionCore/issues/876)) ([da91f82](https://github.com/suoak/AionCore/commit/da91f826bbfdde21e415e9f6080a53075479f729))
* **agent:** preserve generated image paths ([be3567e](https://github.com/suoak/AionCore/commit/be3567e47db20e3d18413ef783488b159e4c2070))
* **agent:** preserve terminal usage and completion state ([#55](https://github.com/suoak/AionCore/issues/55)) ([7932186](https://github.com/suoak/AionCore/commit/793218672287d1a1924c1309ecde0c661127d69f))
* **agent:** silence unused factory bindings after DSH retire ([#51](https://github.com/suoak/AionCore/issues/51)) ([cfbe846](https://github.com/suoak/AionCore/commit/cfbe846f8c168f1679e31fed84f0288af24adfc8))
* **agents:** launch omp through its local CLI instead of the npx bridge ([#855](https://github.com/suoak/AionCore/issues/855)) ([13b5dd4](https://github.com/suoak/AionCore/commit/13b5dd42f941e9dd8a9f3ff06498a3df4449452f))
* **agent:** stop the idle scanner from killing agents with live background tasks ([#811](https://github.com/suoak/AionCore/issues/811)) ([50b6570](https://github.com/suoak/AionCore/commit/50b6570b95b69564037ee89901c8709f889f60b7))
* **ai-agent:** degrade corrupt process registry, atomic writes, and startup-failure child cleanup ([#784](https://github.com/suoak/AionCore/issues/784)) ([812af0b](https://github.com/suoak/AionCore/commit/812af0b96143f0afb80f9d638033467b05c5b2ff))
* **aionrs:** improve provider recovery ([2bbccd8](https://github.com/suoak/AionCore/commit/2bbccd8a5d9cf259e86d4f6b4c4ac997d242c964))
* **antigravity:** collapse agy's U+FFFD runs at text_delta joins ([#888](https://github.com/suoak/AionCore/issues/888)) ([676aae4](https://github.com/suoak/AionCore/commit/676aae437b50740642bae708e40b81030248b5d7))
* **antigravity:** collapse agy's U+FFFD runs at text_delta joins ([#888](https://github.com/suoak/AionCore/issues/888)) ([0324fa9](https://github.com/suoak/AionCore/commit/0324fa93660beaf53337bb12b18d6056a5132953))
* **antigravity:** drop the 'default' UI placeholder model while discovery is empty ([#785](https://github.com/suoak/AionCore/issues/785)) ([18617b3](https://github.com/suoak/AionCore/commit/18617b387c8797eaefa2b9438344442b8ff8e66e))
* **antigravity:** parse TSV output from `agy models` ([#797](https://github.com/suoak/AionCore/issues/797)) ([240e7f4](https://github.com/suoak/AionCore/commit/240e7f45f91584474f818e306f3d2186e74aced1))
* **antigravity:** read the HTTP status before parsing the hook decision ([#867](https://github.com/suoak/AionCore/issues/867)) ([715498c](https://github.com/suoak/AionCore/commit/715498c1ae7443d97ea95609b732a3e1efeee82b))
* **antigravity:** read the HTTP status before parsing the hook decision ([#867](https://github.com/suoak/AionCore/issues/867)) ([60bab79](https://github.com/suoak/AionCore/commit/60bab79d4a10844fb2dc4397cd89c2da09a6548d))
* **antigravity:** route Team over the CLI, which is what agy was already using ([#881](https://github.com/suoak/AionCore/issues/881)) ([2bba782](https://github.com/suoak/AionCore/commit/2bba7824ee8bd25bc2a4914450d0448631365b22))
* **antigravity:** route Team over the CLI, which is what agy was already using ([#881](https://github.com/suoak/AionCore/issues/881)) ([70781cc](https://github.com/suoak/AionCore/commit/70781ccb890ef1aa0d60f11ad29d3f852eb20715))
* **api-types:** re-export GetModelInfoResponse ([3ea2a16](https://github.com/suoak/AionCore/commit/3ea2a16bf7797e00a80ebff70dec800ae8e77a5e))
* **api-types:** restore SideQuestionRequest export ([48c7c3a](https://github.com/suoak/AionCore/commit/48c7c3a3b4689bf5a05adab4b7f80ba5f45e7c17))
* **api-types:** restore WorkspaceBrowseQuery export ([d512213](https://github.com/suoak/AionCore/commit/d5122131de91419c62a693dc818cdec97b25234c))
* **app:** bound the graceful-shutdown tail so the data-dir instance lock is released ([#884](https://github.com/suoak/AionCore/issues/884)) ([3149292](https://github.com/suoak/AionCore/commit/3149292018c5961657dffc6b9e47ea2e2d14f644))
* **app:** bound the graceful-shutdown tail so the data-dir instance lock is released ([#884](https://github.com/suoak/AionCore/issues/884)) ([1e20ab4](https://github.com/suoak/AionCore/commit/1e20ab46f56d92237f6548a67fbd05abdef20726))
* **app:** fall back to default log dir when custom log dir is unusable (AIONUI-231) ([#898](https://github.com/suoak/AionCore/issues/898)) ([bc49db8](https://github.com/suoak/AionCore/commit/bc49db8a6ef5abd56dcef87e2025c4392d6563a2))
* **app:** fall back to default log dir when custom log dir is unusable (AIONUI-231) ([#898](https://github.com/suoak/AionCore/issues/898)) ([a2391ae](https://github.com/suoak/AionCore/commit/a2391ae68fe3f0408b1ade052031ba458bfcba63))
* **app:** harden the shutdown watchdog force-exit path ([f97a379](https://github.com/suoak/AionCore/commit/f97a37997ceb3bc57a5ccc0667e9c36878064b3a))
* **app:** harden the shutdown watchdog force-exit path ([679f34d](https://github.com/suoak/AionCore/commit/679f34dfd535ccd4e016f0ae4abc028406ef76b3))
* **app:** harden the shutdown watchdog force-exit path ([d94b574](https://github.com/suoak/AionCore/commit/d94b5741aa32e69642155f951ad8c14ea7af28bf))
* **app:** keep backend_binary_path cmd.exe-launchable on Windows ([#887](https://github.com/suoak/AionCore/issues/887)) ([8933ab6](https://github.com/suoak/AionCore/commit/8933ab6f1a81f9ee0eb2f569736a20e2fbe118a5))
* **app:** keep backend_binary_path cmd.exe-launchable on Windows ([#887](https://github.com/suoak/AionCore/issues/887)) ([c8bbde6](https://github.com/suoak/AionCore/commit/c8bbde61179012a4c07b341107b665759407f092))
* **app:** reuse the app-level ConversationService in build_cron_state ([#885](https://github.com/suoak/AionCore/issues/885)) ([1860cee](https://github.com/suoak/AionCore/commit/1860ceebcdbabb3c36fbc1cb41cd57a166cdc90e))
* **app:** reuse the app-level ConversationService in build_cron_state ([#885](https://github.com/suoak/AionCore/issues/885)) ([9182eaa](https://github.com/suoak/AionCore/commit/9182eaaf1f9a1f9fe024676dbb1ba876b40ccf93))
* **auth:** extend JWT TTL to 30d to match cookie ([#918](https://github.com/suoak/AionCore/issues/918)) ([8514b71](https://github.com/suoak/AionCore/commit/8514b715a5311c5a61e23d655dd8cb304b952de7))
* **auth:** extend JWT TTL to 30d to match cookie ([#918](https://github.com/suoak/AionCore/issues/918)) ([ecbedfa](https://github.com/suoak/AionCore/commit/ecbedfa622e80b7141cf1f0ab7dd007b23d1714d))
* **auth:** stop CSRF rejecting agy's PreToolUse callback ([#860](https://github.com/suoak/AionCore/issues/860)) ([9a38b98](https://github.com/suoak/AionCore/commit/9a38b986390ea4e157d4797a6056b2b2254e32cf))
* **auth:** stop CSRF rejecting agy's PreToolUse callback ([#860](https://github.com/suoak/AionCore/issues/860)) ([1d91312](https://github.com/suoak/AionCore/commit/1d913129d71b2a253f42d9c644d844c3c3213fe7))
...
* CI (fmt, team MCP, version fixtures) + pair native media paths ([#876](https://github.com/suoak/AionCore/issues/876)) ([1ac37de](https://github.com/suoak/AionCore/commit/1ac37de3e2d9dc260b55f24e6a5a62556a54309f))
* **ci:** cargo fmt + derive Default for skill-evolution params ([a28b382](https://github.com/suoak/AionCore/commit/a28b3823928634ff24a4503b7ecb6acb4b6b3970))
* **claude:** append the assistant preset instead of replacing the system prompt ([#900](https://github.com/suoak/AionCore/issues/900)) ([98cedef](https://github.com/suoak/AionCore/commit/98cedef0f0cd746cd5823e42906933ccc97229e5))
* **claude:** append the assistant preset instead of replacing the system prompt ([#900](https://github.com/suoak/AionCore/issues/900)) ([b4543b4](https://github.com/suoak/AionCore/commit/b4543b471b06e3aa1159339dc15e137773a86c27))
* **claude:** apply model selection in-band so it matches the claude CLI ([#928](https://github.com/suoak/AionCore/issues/928)) ([193a443](https://github.com/suoak/AionCore/commit/193a44376001b10a38132eaf83f5fdf4a6987394))
* **claude:** apply model selection in-band so it matches the claude CLI ([#928](https://github.com/suoak/AionCore/issues/928)) ([706a2eb](https://github.com/suoak/AionCore/commit/706a2ebec8bb33f48e6d2a5fd93a72d91c982d01))
* **claude:** three follow-ups to the tool-step labels ([#872](https://github.com/suoak/AionCore/issues/872)) ([3d3ec63](https://github.com/suoak/AionCore/commit/3d3ec63ebf337f9c87685846773d0fc0761829f0))
* **claude:** three follow-ups to the tool-step labels ([#872](https://github.com/suoak/AionCore/issues/872)) ([f8f7174](https://github.com/suoak/AionCore/commit/f8f7174f6c768c3653e2f57843b161fa23758266))
* **cli-version:** deliver the version-drift notice, and stop it reading as an error ([#817](https://github.com/suoak/AionCore/issues/817)) ([c0e9e9d](https://github.com/suoak/AionCore/commit/c0e9e9d44572a588e3ad79b6ac435fbe53f71b99))
* **clippy:** allow ApiError in skill-evolution routes ([953aaff](https://github.com/suoak/AionCore/commit/953aaffaae821355ce2784edda9e54d64d5207b5))
* **cli:** register unindexed top-level subcommands in the capability index ([#929](https://github.com/suoak/AionCore/issues/929)) ([f3e9503](https://github.com/suoak/AionCore/commit/f3e950349dd6f868a011b3912812a603ae943c1b))
* **cli:** register unindexed top-level subcommands in the capability index ([#929](https://github.com/suoak/AionCore/issues/929)) ([c490161](https://github.com/suoak/AionCore/commit/c490161df4ee7ab34830e81a67473d416ca78f03))
* **codex:** send the assistant preset as developerInstructions, not baseInstructions ([#897](https://github.com/suoak/AionCore/issues/897)) ([c386649](https://github.com/suoak/AionCore/commit/c386649c35ba7916a450d713220a022348d36b42))
* **codex:** send the assistant preset as developerInstructions, not baseInstructions ([#897](https://github.com/suoak/AionCore/issues/897)) ([a3d47a9](https://github.com/suoak/AionCore/commit/a3d47a91de714f6d5b6f2b5339d14b1d84ebfbbd))
* **conversation:** apply a cancel that arrives while the agent is still building ([#747](https://github.com/suoak/AionCore/issues/747)) ([42fc44b](https://github.com/suoak/AionCore/commit/42fc44b51867c525759fd89d4efd7713f0c7f445))
* **conversation:** apply agent session titles at the relay level ([#896](https://github.com/suoak/AionCore/issues/896)) ([2efd149](https://github.com/suoak/AionCore/commit/2efd149d48f30a274e8c1c8d820ed7cf43342094))
* **conversation:** apply agent session titles at the relay level ([#896](https://github.com/suoak/AionCore/issues/896)) ([1a2c86a](https://github.com/suoak/AionCore/commit/1a2c86a8a702aa1d7aa081114da93ac3c734adfc))
* **conversation:** brand temporary workspaces ([17a8a30](https://github.com/suoak/AionCore/commit/17a8a300f18281708089588a7f16756f4baaf685))
* **conversation:** drop unused Arc import after DSH retire ([#52](https://github.com/suoak/AionCore/issues/52)) ([0be0a38](https://github.com/suoak/AionCore/commit/0be0a38cad162b2c792ebf249dea3034e7c8ee37))
* **conversation:** expose runtime restart endpoint ([cc559ab](https://github.com/suoak/AionCore/commit/cc559ab4c623edb405573721b101fef25d826634))
* **conversation:** format journal transcript and drop unused visibility ([1c79c4b](https://github.com/suoak/AionCore/commit/1c79c4bcd54421021544739164a8ebfbeeae62e5))
* **conversation:** mark pruned tool results compacted even when short ([8ed82b3](https://github.com/suoak/AionCore/commit/8ed82b357dd31ce541316ea3bf3a84a120e4303e))
* **conversation:** tell the client when a turn is cancelled before its agent exists ([#827](https://github.com/suoak/AionCore/issues/827)) ([86eff2f](https://github.com/suoak/AionCore/commit/86eff2fa1dff988860aece3d5879bc10618dbb3a))
* **db:** remap branded 038/039 collisions so 0.1.70 databases can open ([#42](https://github.com/suoak/AionCore/issues/42)) ([ed3014a](https://github.com/suoak/AionCore/commit/ed3014a187b0c93e796eabe4efb650dedbb76bb1))
* **db:** renumber merged migrations after branded history ([a97d825](https://github.com/suoak/AionCore/commit/a97d825aa81d878c75d441c253bf37beac8d7a11))
* **db:** widen migration-030 pre-repair gate to any pre-030 start point ([#756](https://github.com/suoak/AionCore/issues/756)) ([6e2b33d](https://github.com/suoak/AionCore/commit/6e2b33d75bfa0b5c504514fc25d1f09d6db7b3f7))
* **engine:** update rust crate getrandom-6f8ce4dd05d13bba to 0.4 ([#212](https://github.com/suoak/AionCore/issues/212)) ([0cf059b](https://github.com/suoak/AionCore/commit/0cf059b283fcd7d795b0bd6505da7fce3d655a2f))
* **extension:** bound the builtin-skills materialize lock acquisition (AIONUI-168) ([#903](https://github.com/suoak/AionCore/issues/903)) ([9c62d7f](https://github.com/suoak/AionCore/commit/9c62d7fc7a319beb7b8bb236bb58bb5bb0e65b1e))
* **extension:** bound the builtin-skills materialize lock acquisition (AIONUI-168) ([#903](https://github.com/suoak/AionCore/issues/903)) ([b584da0](https://github.com/suoak/AionCore/commit/b584da01e1608da15438264e34ea506b4d947d95))
* **file:** decode UTF-16 text and retry locked reads ([#68](https://github.com/suoak/AionCore/issues/68)) ([3e46b91](https://github.com/suoak/AionCore/commit/3e46b91a3f0176c34401c0303270d0a12de654bd))
* **grok:** update managed package version ([#20](https://github.com/suoak/AionCore/issues/20)) ([5effa5a](https://github.com/suoak/AionCore/commit/5effa5ab37b53b8c3cd27dc7b87be17b1162ced3))
* **journal:** replace stale input projections on rebuild ([1a2fc58](https://github.com/suoak/AionCore/commit/1a2fc586c36af6e5cf7bdaa9e92bb13d11473a6c))
* **journal:** scope replay helpers to tests ([7f2463e](https://github.com/suoak/AionCore/commit/7f2463e6983890745157cec41f31a7ff7cb6bc67))
* **journal:** scope unused cursor replay to tests ([27b27b9](https://github.com/suoak/AionCore/commit/27b27b9684eddea05dd8c735aaaa6daccc62d03c))
* **journal:** scope unused cursor replay to tests ([d189e99](https://github.com/suoak/AionCore/commit/d189e990ede5106a67c2f4a8f27955c4cd9afc67))
* **journal:** scope unused cursor replay to tests ([577d434](https://github.com/suoak/AionCore/commit/577d434e6310cbf50fc501a656ee7a3dc18c473d))
* **office:** discover legacy Windows install path ([#13](https://github.com/suoak/AionCore/issues/13)) ([27879ce](https://github.com/suoak/AionCore/commit/27879cea1a508c960db80c456655a3a0c7c6c1d3))
* **process:** reap tool subprocesses that left the process group ([#753](https://github.com/suoak/AionCore/issues/753)) ([7bc0260](https://github.com/suoak/AionCore/commit/7bc026006c55a7f38d94f86a44af6d36105284b3))
* **project:** emit real-case absolute path to agents, not folded canonical ([#809](https://github.com/suoak/AionCore/issues/809)) ([f0f4fbd](https://github.com/suoak/AionCore/commit/f0f4fbd1234a039861f2b3e857cd821337c37672))
* **project:** keep mounted targets when one fs/subscribe target fails (AIONUI-236) ([#902](https://github.com/suoak/AionCore/issues/902)) ([76b1781](https://github.com/suoak/AionCore/commit/76b1781cc0566a49729c4a88c4051f8ecd22f751))
* **project:** keep mounted targets when one fs/subscribe target fails (AIONUI-236) ([#902](https://github.com/suoak/AionCore/issues/902)) ([2f5edd4](https://github.com/suoak/AionCore/commit/2f5edd4151ed0d6ce59e8491068c95b0578f5c58))
* **release:** bump only aionui-* crate versions in Cargo.lock ([9431e3b](https://github.com/suoak/AionCore/commit/9431e3b41ffcc65986f9e0e040f5849553fe9b22))
* restore direct CLI Team MCP capabilities ([#853](https://github.com/suoak/AionCore/issues/853)) ([fe99ff6](https://github.com/suoak/AionCore/commit/fe99ff6051cf5d0a766332e56ffa66e9d8c61234))
* **runtime:** add bounded retry to managed node version probe ([#771](https://github.com/suoak/AionCore/issues/771)) ([1dee9f1](https://github.com/suoak/AionCore/commit/1dee9f1e961a529f7aae701f97ddb1deeab64655))
* **runtime:** find agent CLIs installed by bun and by vendor installers ([#856](https://github.com/suoak/AionCore/issues/856)) ([8881980](https://github.com/suoak/AionCore/commit/8881980401da402eaa6ecf73e884c104635b34ff))
* **runtime:** log npm/npx probe stderr and missing-executable snapshot (AIONUI-62) ([#904](https://github.com/suoak/AionCore/issues/904)) ([9c51249](https://github.com/suoak/AionCore/commit/9c512493dccdd78a5d55e948f2d34d881af6b0ea))
* **runtime:** log npm/npx probe stderr and missing-executable snapshot (AIONUI-62) ([#904](https://github.com/suoak/AionCore/issues/904)) ([9124b20](https://github.com/suoak/AionCore/commit/9124b2078cdd3f5029553a0a3ee3d177b1b998d9))
* **runtime:** retry transient bundled-node activation copy and reclassify persistent I/O failures ([#760](https://github.com/suoak/AionCore/issues/760)) ([23d2ec6](https://github.com/suoak/AionCore/commit/23d2ec658dd3dfda89156f7119945ac3c7141611))
* **runtime:** update pinned Grok Build package ([#78](https://github.com/suoak/AionCore/issues/78)) ([0847065](https://github.com/suoak/AionCore/commit/08470654b2821a44e71d203ec0282fb95982449f))
* rustfmt and team coordination MCP spawn mapping ([042bdb1](https://github.com/suoak/AionCore/commit/042bdb150f39ff0f8543c4ba05fae389001ac19f))
* **server:** emit AIONCORE_READY marker once serving begins ([#761](https://github.com/suoak/AionCore/issues/761)) ([8b08130](https://github.com/suoak/AionCore/commit/8b08130365ec7c883736c0b4aabcef471002dd7b))
* **session-message:** align recipient block capabilities wording with sender ([#955](https://github.com/suoak/AionCore/issues/955)) ([9bfb2ad](https://github.com/suoak/AionCore/commit/9bfb2adbab1aca47bcd1a644446aeee6c41aab4f))
* **session:** keep claude session cost cumulative across process respawns ([#767](https://github.com/suoak/AionCore/issues/767)) ([f498e9d](https://github.com/suoak/AionCore/commit/f498e9d2deb57d3491d5a107b622d24d5c8df7df))
* **session:** retry claude session-title generation with timeout and observability ([#843](https://github.com/suoak/AionCore/issues/843)) ([c59e937](https://github.com/suoak/AionCore/commit/c59e937a0cc49327a6756c32fb77213e1abe2224))
* **session:** settle cards through teardown and resume so no stored row spins forever ([#766](https://github.com/suoak/AionCore/issues/766)) ([3f61cc4](https://github.com/suoak/AionCore/commit/3f61cc490ec589f6602eeeb30487443cd9d1061e))
* **session:** stop reporting still-running codex commands as cancelled ([#783](https://github.com/suoak/AionCore/issues/783)) ([a326fb2](https://github.com/suoak/AionCore/commit/a326fb260905c82961ca9730461f872068ccb255))
* **skills:** enforce zip extraction limits ([0b7a657](https://github.com/suoak/AionCore/commit/0b7a657fbb91a870a4151588cd98014f9b61724b))
* **skills:** enforce zip extraction limits ([3283822](https://github.com/suoak/AionCore/commit/328382220e01b34a67a9f78ac2cbd1b6a2390c5c))
...
* **sync:** reconcile upstream session and migration changes ([1d6f251](https://github.com/suoak/AionCore/commit/1d6f251d9c405d97cd72096608637ad8194a5d82))
...
* **team:** ack messages observed via read_messages with active turn ([304af74](https://github.com/suoak/AionCore/commit/304af74b61def1f0781f7a0ea39209478df48f9a))
* **team:** complete interrupt coordinator wiring ([65917d8](https://github.com/suoak/AionCore/commit/65917d89d615351a1d749de21499fa04a6d55373))
* **team:** page team_read_messages oldest-first and stop losing message content ([e7b7a31](https://github.com/suoak/AionCore/commit/e7b7a314470e19f47f7bee95fab4e6b2232bc164))
* **team:** preserve and prioritize directed messages ([32a9bcb](https://github.com/suoak/AionCore/commit/32a9bcbea9041cd3cc20e2aed411dec92407f97f))
* **team:** prioritize interrupt replacement work ([7dc1f78](https://github.com/suoak/AionCore/commit/7dc1f786af191670887f5b72ec62646633aa67c8))
* **team:** publish paused slot work immediately on stop ([fff7327](https://github.com/suoak/AionCore/commit/fff7327d5495a8990741ec5933cd3cb121bbfae1))
* **team:** remove unused MCP refresh wrapper ([4552e6c](https://github.com/suoak/AionCore/commit/4552e6c553ee4e2a20c2cd187f8f541c10d27c2c))
...
* **team:** restore clear-context stdio params ([b76942e](https://github.com/suoak/AionCore/commit/b76942e1d76cb6d611ed81fcff0dfde0740e9e09))
* **team:** restore interrupt API contracts ([440371d](https://github.com/suoak/AionCore/commit/440371dde033f0f81a92765a186ab8d48ccdaa1d))
* **team:** restore lead implementation exception ([080f751](https://github.com/suoak/AionCore/commit/080f751ac1d03091074b86c840079591a0aa9327))
* **team:** retry failed mailbox deliveries ([3dc1e0a](https://github.com/suoak/AionCore/commit/3dc1e0a29a0cc10e09740f950e9ec113af73f049))
* **team:** support spaced names in clear command ([06103b5](https://github.com/suoak/AionCore/commit/06103b57f851a7599282fcc8bee4d84fb406d0df))
* **team:** wire the interrupt-agent CLI path and make discard non-destructive ([45a8f94](https://github.com/suoak/AionCore/commit/45a8f944e6b58fa0f755f8ba003483acf5a992ef))
* **test:** align mid-turn session-message tests with skipped Core [#836](https://github.com/suoak/AionCore/issues/836) ([a1ef271](https://github.com/suoak/AionCore/commit/a1ef2717e2a7bd1ddbd8b6178bd07338b95954b0))
* **test:** retarget cli_version Newer fixtures past Codex 0.150.1 ([785e706](https://github.com/suoak/AionCore/commit/785e706f38eedf99dff82dfee437796ec9ff2892))


### Performance Improvements

* **office:** bound preview port probes ([#92](https://github.com/suoak/AionCore/issues/92)) ([8fd8f77](https://github.com/suoak/AionCore/commit/8fd8f773db5ce13bcb61d1854dd04c64506dc808))
* slim auto-inject skill descriptions to the injection budget ([#930](https://github.com/suoak/AionCore/issues/930)) ([536e25b](https://github.com/suoak/AionCore/commit/536e25bc19b5b2545df545cf2ca06bfc7526d877))
* slim auto-inject skill descriptions to the injection budget ([#930](https://github.com/suoak/AionCore/issues/930)) ([9b7e4ce](https://github.com/suoak/AionCore/commit/9b7e4cee9c14faabb4965bc364e3a093c1813e61))
...
* **session:** run the user's own claude/codex, with one shared version-drift path ([#799](https://github.com/suoak/AionCore/issues/799)) ([ae817e3](https://github.com/suoak/AionCore/commit/ae817e32d7f7f24246fcb0001e334a344d59f351))


### Documentation

* refresh architecture crate catalog ([#791](https://github.com/suoak/AionCore/issues/791)) ([4d59a21](https://github.com/suoak/AionCore/commit/4d59a21aaa0b4ff8210e04cea41872920a2f8a65))
* **skill:** ask theme and studio outline confirmation before filling ([f0c27e2](https://github.com/suoak/AionCore/commit/f0c27e236aba91ab704becbdf4c912b8590f7afa))
* **skill:** brand themes + officecli deck theme-remap ([#103](https://github.com/suoak/AionCore/issues/103)) ([21520da](https://github.com/suoak/AionCore/commit/21520da34885b93ff830e253dca8fd0d02993638))
* **skill:** layout-query + P1.8 post-gen prompts + theme strips ([ae565cd](https://github.com/suoak/AionCore/commit/ae565cda37c0546e1d3ca1505b2a55deb63cfe75))
* **skill:** list industry theme pack ids + strips ([#107](https://github.com/suoak/AionCore/issues/107)) ([932ef8a](https://github.com/suoak/AionCore/commit/932ef8a73525e13881af58a6b4e319a0c9f26048))
* **skill:** long-deck scaffold + wireframe compare guidance ([#104](https://github.com/suoak/AionCore/issues/104)) ([8ec86ec](https://github.com/suoak/AionCore/commit/8ec86ec81586de3091c70534e316d8eb5958bf05))
* **skill:** note officecli deck export-pdf in workmate-presentation ([31648b2](https://github.com/suoak/AionCore/commit/31648b2da44c8fc081ed3085adfa8a080e06c4a8))
* **skill:** note officecli deck export-pdf in workmate-presentation ([1f49be3](https://github.com/suoak/AionCore/commit/1f49be35e4575805492e3d90a0459113cc278da4))
* **skill:** post-gen prompts + WorkMate theme strips ([e6acd3b](https://github.com/suoak/AionCore/commit/e6acd3b196982e74a1737c6e6771ca3d52c2599c))
* **skill:** prefer deck layout-query (OfficeCLI 1.0.159) ([483c4f0](https://github.com/suoak/AionCore/commit/483c4f0878e90bf38353ea9bdd64a2c999d9cc31))
* **skill:** prefer officecli deck layout-query for layout pick ([5dd2f12](https://github.com/suoak/AionCore/commit/5dd2f1206ee6d7cf21a06143270b4409f6165a35))
* **skill:** prefer richer roles and capacity-aware layouts ([aaf3322](https://github.com/suoak/AionCore/commit/aaf332209bbcf808cf729ee5164ad298748d8aa2))
* **skill:** prefer richer roles and capacity-aware layouts ([8d074c1](https://github.com/suoak/AionCore/commit/8d074c1d621ea1c02ea0ae4feace2b597d2ba4f8))
* **skill:** presentation outline confirmation before filling ([9ac24bf](https://github.com/suoak/AionCore/commit/9ac24bfafaf6d6a1eada54128ae15fc1fddd8937))
* **skill:** suggest layout switch and image fill after outline ([#99](https://github.com/suoak/AionCore/issues/99)) ([21a769d](https://github.com/suoak/AionCore/commit/21a769d8fb8713f1466767f33948b2334c256ab6))
...
* **agent-center:** MVP Core model/API/routes (#109)
* **agent-center:** expose preview_mode on try-run plan (#110)

### Chores

* **acp,cli-version:** bump registry pins and verified CLI floors (#108)

### Documentation

* **skill:** list industry theme pack ids + strips (#107)
...
## [0.2.5](https://github.com/suoak/AionCore/compare/v0.2.4...v0.2.5) (2026-09-02)

### Features

* **skills:** workmate-presentation skill — ask theme and studio outline confirmation before filling (#94)

### Bug Fixes

* **skills:** enforce zip extraction limits (#87)
...
* **tools:** correlate native aionrs execution phases with trajectory events
